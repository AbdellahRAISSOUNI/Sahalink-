...
const Navbar = () => {
  ...
  return (
    <div className="mb-[35px] flex flex-col-reverse justify-between gap-6 md:flex-row">
      {/* Search bar */}
      <div className="flex h-[52px] max-w-[458px] flex-row rounded-[100px] bg-[#1c1c24] p-4 py-2 pr-2 lg:flex-1">
        <input
          type="text"
          placeholder="Search for records"
          className="font normal flex w-full bg-transparent font-epilogue text-[14px] text-white outline-none placeholder:text-[#4b5264]"
        />
